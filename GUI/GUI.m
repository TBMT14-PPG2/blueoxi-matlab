...
ax(1).XColor = 'k';
ax(1).YColor = 'k';
% line(handles.time_peak,handles.saturation,'Color','r')
% ax(2).XColor = 'r';
% ax(2).YColor = 'r';
                        ...
                        for i=count-length(red)-k:count-k
                            ...
                            if t(i-k)>lastpeaktime+30/Pulse(end)
                                ...
                                if ( ( filtered(i-k)>=max(filtered(i-k+1:i)) )  && ...
                                    ...
                                    hAx=plotyy(handles.oxy_graph,ptp_time,Pulse,'-k',tpt_time,Sat,'-r')
...
switch choice
    case 'Yes'
        uisave({'filtered', 'ptp_time', 'Pulse', 'PercentageOfMax', 'R','t'});
    case 'No'  
    case 'Cancel'
end
